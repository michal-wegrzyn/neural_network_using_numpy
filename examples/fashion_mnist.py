...
nn = NN([784, 24, 24, 10], [NN.AFunc.SELU_pair, NN.AFunc.PReLU_pair(0.01), NN.AFunc.softmax_pair], NN.LFunc.cross_entropy_pair, 0.001)

with gzip.open('../datasets/fashion_mnist.pkl.gz', 'rb') as file:
...
train_data = augment.shift(train_data, [[0,0],[1,1],[-1,-1]], 0.0, (28,28))
train_data = augment.flip(train_data, ((),(1)), (28,28), (784,1))
